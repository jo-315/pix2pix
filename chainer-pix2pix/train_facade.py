...
def main():
    ...
    parser.add_argument('--traindataset', '-i', default='../images/train/',
                        help='Directory of image files.')

    parser.add_argument('--testdataset', '-t', default='../images/test/',
                    help='Directory of image files.')
    ...
    trainer = training.Trainer(updater, (args.epoch, 'epoch'), out=output_path)
